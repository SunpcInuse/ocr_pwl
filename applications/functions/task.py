...
class OCRWebUtils():
    def __init__(self) -> None:
        self.ocr = RapidOCR(det_model_path="applications/functions/lib/ch_PP-OCRv4_det_server_infer.onnx",
                            rec_model_path="applications/functions/lib/ch_PP-OCRv4_rec_infer.onnx")
